...
-   birth order of child of interest
    -   `birth_order`
...
-   Degree of coverage (relative to *Age of child*
    ...
    -   1 = partial (1 dose for those >= 3 y/o but < 13 y/o)
    -   2 = full (2 doses for those >= 3y/o and < 13 y/o and >= 1 dose for those 6 months to 3 y/o or those >= 1 dose for those >= 13y/o to < 18 y/o)
...
**all derivationis of coverage were inferred from Vaccination Schedule Recommended by the Japan Pediatric Society as of October 27, 2024 and MHLW Q&A on Influenza
...
-   Sex of child of interest (reference *Age of child*), `sex_of_interest` 
    -   0 = male
    -   1 = female
-   Age of child of interest, `age_of_interest`
-   schooling category of COI based on their age, `age_cat`
-   Number of children of interest (<18y/o), `child_of_interest`
-   birth order of child of interest, `birth_order`
...
-   Total number of siblings under 18 y/o, `child_siblings`
-   Total number of siblings (both under and over 18 y/o), `test_child_siblings`
-   Total number of siblings (>18 y/o), `siblings_over_18`
...
-   Annual household income (numeric), `test_household_income`
...
-   Child's parent working in healthcare, `parents_healthcare`
    -   0 = Neither
    -   1 = Responding father works in HC
    -   2 = Responding mother works in HC
*note that we can only extract the status of if the child's responding parent is working in healthcare*
*and not their partner as we were not provided with the partner's industry of work*
...
-   Highest educational attainment attained by father, `father_highest_education`
    -   0 = Junior high or high school
...
-   Highest educational attinment attained by mother, `mother_highest_education`
    -   0 = Junior high or high school
    -   1 = Junior/Technical college
    -   2 = Tertiary
    -   3 = Post-graduate education
